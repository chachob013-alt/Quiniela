...
<div class="p-8 bg-gray-100 overflow-x-auto">
    <div class="bracket-grid">
        ...
        <div class="flex flex-col gap-10">
            @foreach($matchesRound1 as $match)
                <div class="match-box connector-right">
                    <label class="text-[10px] font-bold text-gray-400">{{ $match['id'] }}</label>
                        ...
                        <ul x-show="open" @click.away="open = false" 
                            ...
                            @php
                                // Aquí consultas tu modelo WorldCupMatch
                                 $game = \App\Models\WorldCupMatch::where('match_number', $match['id'])->with('team1', 'team2')->first();
                            @endphp
        ...
        <div class="flex flex-col gap-10">
            @foreach(['P89', 'P90', 'P93', 'P94'] as $matchId)
                <div class="match-box connector-right">
